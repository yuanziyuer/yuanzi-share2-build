...
/***/ function(module, exports, __webpack_require__) {
  ...
  // React.js News Feed (RSS)
  var url = '';
  //const url = 'http://101.251.204.42:3010/strategies/56ea8a21399a596627cbf67e?version=v2';
  /**
   * React Starter Kit (https://www.reactstarterkit.com/)
   *
   * Copyright © 2014-2016 Kriasoft, LLC. All rights reserved.
  ...
  var strategy = {
    ...
    resolve: function resolve(_ref, _ref2) {
      ...
      var items = void 0;
      lastFetchTime = new Date();
      lastFetchTask = (0, _fetch2.default)('http://test.iyuanzi.com/strategies/' + path + '?version=v2').then(function (response) {
        return response.json();
      }).then(function (data) {
        items = data;
        return items;
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _TopicType = __webpack_require__(44);
  ...
  var topic = {
    ...
    resolve: function resolve(_ref, _ref2) {
      ...
      var items = void 0;
      lastFetchTime = new Date();
      lastFetchTask = (0, _fetch2.default)('http://test.iyuanzi.com/topics/' + path + '?version=v2').then(function (response) {
        return response.json();
      }).then(function (data) {
        items = data;
        return items;
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // React.js News Feed (RSS)
  //const url = 'http://www.iyuanzi.net/events/56c38551428be02d3a8e4c9a?version=v2';
  ...
  var topic = {
    ...
    resolve: function resolve(_ref, _ref2) {
      ...
      var items = void 0;
      lastFetchTask = (0, _fetch2.default)('http://test.iyuanzi.com/events/' + path + '?version=v2').then(function (response) {
        return response.json();
      }).then(function (data) {
        items = data;
        return items;
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // React.js News Feed (RSS)
  //const url = 'http://www.iyuanzi.net/photos/566b967ac46bea43309ae0a5?version=v2';
  ...
  var topic = {
    ...
    resolve: function resolve(_ref, _ref2) {
      ...
      var items = void 0;
      lastFetchTime = new Date();
      lastFetchTask = (0, _fetch2.default)('http://test.iyuanzi.com/photos/' + path + '?version=v2').then(function (response) {
        return response.json();
      }).then(function (data) {
        items = data;
        return items;
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var routes = [__webpack_require__(119), __webpack_require__(123), __webpack_require__(127), __webpack_require__(131), __webpack_require__(143), __webpack_require__(147), __webpack_require__(153)]; /**
                                                                                                                                                                                                                       * React Starter Kit (https://www.reactstarterkit.com/)
                                                                                                                                                                                                                       *
                                                                                                                                                                                                                       * Copyright © 2014-2016 Kriasoft, LLC. All rights reserved.
                                                                                                                                                                                                                       *
...
/***/ function(module, exports, __webpack_require__) {
      ...
      var insertCss = __webpack_require__(85);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _withStyles = __webpack_require__(89);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _Strategy = __webpack_require__(132);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _CdnUrl = __webpack_require__(142);
        ...
        steps.map(function (item, index) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('img', { src: _CdnUrl2.default.format(item.imgUrl) + '@1pr.jpg', alt: '' }),
              _react2.default.createElement(
                'p',
                null,
                item.description
      ...
      _react2.default.createElement(
        ...
        photos.map(function (item, index) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              { href: '/photos/' + item.photoId + '/view' },
              _react2.default.createElement('img', { className: _Strategy2.default.header, src: _CdnUrl2.default.format(item.content[0].img) + '@280w_280h_1pr.jpg', alt: '' })
            ),
            _react2.default.createElement('img', { className: _Strategy2.default.avatar, src: _CdnUrl2.default.format(item.owner.avatar) + '@56h_56w_1pr.jpg', alt: '' }),
            _react2.default.createElement(
              'p',
  ...
  function Strategy(_ref) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement('img', { src: _CdnUrl2.default.format(strategy.cover) + '@440h_1pr.jpg', alt: '' }),
        _react2.default.createElement(
          'div',
          { className: _Strategy2.default.avatar },
          _react2.default.createElement('img', { src: _CdnUrl2.default.format(strategy.owner.avatar) + '@108h_108w_1pr.jpg', alt: '' }),
          _react2.default.createElement(
            'h3',
            null,
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'audio',
          { src: strategy.soundStory, controls: true },
          '你的浏览器不支持音频播放'
        )
      ),
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _dateFormat = __webpack_require__(140);
  ...
  function CommentItem(_ref) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement('img', { className: _Comment2.default.avatar, src: _CdnUrl2.default.format(data.commentUser.avatar) + '@48w_48h_1pr.jpg' })
      ),
      _react2.default.createElement(
        'div',
        ...
        _react2.default.createElement(
          ...
          data.images.map(function (value) {
            return _react2.default.createElement(
              'li',
              { key: value },
              _react2.default.createElement('img', { src: _CdnUrl2.default.format(value) + '@102w_102h_1pr.jpg', alt: '' })
            );
          })
        )
      )
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _moment = __webpack_require__(141);
...
/***/ function(module, exports) {
  ...
  var CdnUrl = {
    format: function format(url) {
      if (url.indexOf('http://yuanzi-dev.oss-cn-hangzhou.aliyuncs.com') !== -1) {
        return url.replace('http://yuanzi-dev.oss-cn-hangzhou.aliyuncs.com', 'http://assets-dev.iyuanzi.net');
      } else if (url.indexOf('http://yuanzi-beijing.oss-cn-beijing.aliyuncs.com') !== -1) {
        return url.replace('http://yuanzi-beijing.oss-cn-beijing.aliyuncs.com', 'http://assets.iyuanzi.net');
      } else if (url.indexOf('http://img.iyuanzi.net') !== -1) {
        return url.replace('http://img.iyuanzi.net', 'http://assets.iyuanzi.net');
      }
      return url;
    }
  };
  exports.default = CdnUrl;
  ...
  function Topic(_ref) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement('img', { src: _CdnUrl2.default.format(topic.cover) + '@694h_1pr.jpg', alt: '' })
      ),
      _react2.default.createElement(
        'div',
          ...
          topic.strategies.map(function (item) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement('img', { className: _Topic2.default.cover, src: _CdnUrl2.default.format(item.cover) + '@357h_357w_1pr.jpg', alt: '' })
              ),
              _react2.default.createElement(
                'div',
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, "._2tU3{padding-left:20px;padding-right:20px}._36pJ img{height:347px;width:100%;-o-object-fit:cover;object-fit:cover}.P0Ts{margin:0 auto 45px 0;padding:0;max-width:768px}._2Zor,.P0Ts{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;width:100%}._2Zor{box-sizing:border-box;background:#fff;padding:30px 12px 40px}._2Zor ._30vZ{font-size:18px}._2Zor ._2S8u{margin:19px 0 15px;font-size:12px}._2Zor ._2S8u span{font-size:12px;color:#999}._2Zor ._2S8u span:nth-child(2){color:#ff989e}._2Zor .hN1L{font-size:10px;color:#999}._1NDr{width:100%;padding-top:6px;background:#fcf8f5}._1NDr ._3iUr{border-left:6px solid #ff989e;height:31px;padding-left:15px}._1NDr ._3iUr span{font-size:14px}._1NDr ._3iUr span:nth-child(2){color:#999}._1NDr ul{padding:0 1.6% 20px;width:96.8%;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap;list-style:none}._1NDr ul li{margin-top:6px;box-shadow:0 15px 10px -15px #ccc;width:49.175%;background:#fff}._1NDr ul li a{-webkit-tap-highlight-color:rgba(0,0,0,0)}._1NDr ul li a ._36pJ{width:100%}._1NDr ul li ._1Fyz{padding:0 12px 12px}._1NDr ul li ._1Fyz p{margin:6px 0}._1NDr ul li ._1Fyz ._30vZ{font-size:13px}._1NDr ul li ._1Fyz .ZJCp{color:#666;font-size:11px}._1NDr ul li ._1Fyz .ZJCp ._2S8u{color:#ff989e}._1NDr ul li ._1Fyz .hN1L{border-top:1px solid #e5e5e5}._1NDr ul li ._1Fyz .hN1L p{margin-top:9px;font-size:10px;color:#666}._1NDr ul li:nth-child(even){margin-left:1.65%}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _NumberFotmat = __webpack_require__(151);
  ...
  function Event(_ref) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement('img', { className: _Event2.default.cover, src: _CdnUrl2.default.format(event.cover) + '@440h_1pr.jpg', alt: '' }),
        _react2.default.createElement('img', { className: _Event2.default.avatar, src: _CdnUrl2.default.format(event.owner.avatar) + '@108h_108w_1pr.jpg', alt: '' }),
        _react2.default.createElement(
          'p',
        ...
        _react2.default.createElement(
          ...
          event.participants.map(function (value, index) {
            return _react2.default.createElement(
              'li',
              { key: value.userId },
              _react2.default.createElement('img', { className: _Event2.default.avatar, src: _CdnUrl2.default.format(value.participant.avatar) + '@112h_112w_1pr.jpg', alt: '' })
            );
          })
        )
      ),
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _numeral = __webpack_require__(152);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _Photo = __webpack_require__(154);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _Photo = __webpack_require__(155);
  ...
  function Photo(_ref) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement('img', { src: _CdnUrl2.default.format(photo.content[0].img) + '@768h_768w_1pr.jpg', alt: '' })
      ),
      _react2.default.createElement(
        'div',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('img', { className: _Photo2.default.avatar, src: _CdnUrl2.default.format(photo.owner.avatar) + '@82h_82w_1pr.jpg', alt: '' })
        ),
        _react2.default.createElement(
          'div',
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, ".sf3Z{padding-left:20px;padding-right:20px}._1Nld{margin:0 0 45px;padding:0;max-width:768px;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;width:100%;background-color:#fcf8f5}._25cW img{height:347px;width:100%;-o-object-fit:cover;object-fit:cover}._2boW{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;width:100%;background:#fff;border-bottom:1px solid #e5e5e5}._2boW ._3nx2 ._1i7a{margin:17px 17px 0;height:41px;width:41px;border-radius:20.5px}._2boW ._3JkA p{margin:14px 0}._2boW ._3JkA .aX5j{color:#ff989e;font-size:12px}._2boW ._3JkA ._3K_D{font-size:17px;color:#666}._2boW ._3JkA .H0ny{font-size:12px;color:#999}", ""]);
